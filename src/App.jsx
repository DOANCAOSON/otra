    ...
    return (
        <>
            <div className="">
                ...
                {/* slider */}
                <BannerSlider currentIndex={currentIndex} refSliderBanner={ref} setCurrentIndex={setCurrentIndex} />
                ...
                {/* a */}
                <StoreChain selectedItem={selectedItem} handleItemClick={handleItemClick} />
                {/* footer */}
                <Footer />
            </div>
        </>
